...
import { backendEngineers, frontendEngineers } from "../util/constants";
  ...
  return (
    <main className="">
      <section className="relative h-screen w-full">
        ...
        <div className="absolute inset-2 left-4 md:inset-0 flex flex-col justify-center items-center">
